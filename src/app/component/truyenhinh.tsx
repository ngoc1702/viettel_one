...
export default function TRUYENHINH({ posts }: { posts: Post[] }) {
  ...
  const filteredPosts = posts.filter((post: Post) =>
    post.categories?.some(
      (category: Category) => category.title === "Combo internet - truyền hình"
    )
  );

  return (
    <>
      <div className="max-content px-3 md:px-0 pb-10 md:pb-20 z-1">
          ...
          {filteredPosts.length > 0 && (
            <div className="mt-4 md:mt-6 relative">
              ...
              <Swiper
                ...
                className="mySwiper"
              >
                 <div className="swiper-button-prev absolute left-0 top-1/2 -translate-y-1/2 z-10" ></div>
                 <div className="swiper-button-next absolute right-0 top-1/2 -translate-y-1/2 z-10" />
